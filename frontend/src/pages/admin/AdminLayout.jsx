...
export default function AdminLayout({ children }) {
  ...
  const liens = [
    { path: '/admin', label: 'Tableau de bord', emoji: '🏠' },
    { path: '/admin/utilisateurs', label: 'Utilisateurs', emoji: '👥' },
    { path: '/admin/tarifs', label: 'Tarifs', emoji: '💰' },
    { path: '/admin/forfaits', label: 'Forfaits', emoji: '📦' },
    { path: '/admin/options', label: 'Options de finition', emoji: '⚙️' },
  ];
    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <aside className="hidden md:flex flex-col w-64 bg-white border-r
        ...
        <div className="p-6 border-b border-gray-100">
          <Link src="/LogoFP.png" className="flex items-center gap-3">
